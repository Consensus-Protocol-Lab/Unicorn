...
func testNewValidatorSet(t *testing.T) {
	...
	// Create ValidatorSet
	valSet := NewSet(ExtractValidators(b), interfaces.RoundRobin)
	if valSet == nil {
...
func testCalcProposerByIndex(t *testing.T) {
	...
	valset := newDefaultSet(addrs, interfaces.RoundRobin)
...
func testNormalValSet(t *testing.T) {
	...
	valSet := newDefaultSet([]common.Address{addr1, addr2}, interfaces.RoundRobin)
	if valSet == nil {
...
func testEmptyValSet(t *testing.T) {
	valSet := NewSet(ExtractValidators([]byte{}), interfaces.RoundRobin)
	if valSet == nil {
...
func testStickyProposer(t *testing.T) {
	...
	valSet := newDefaultSet([]common.Address{addr1, addr2}, interfaces.Sticky)
