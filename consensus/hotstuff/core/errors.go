...
var (
	...
	// errInvalidValidatorSeals is returned if the committed seal is not signed by any of parent validators.
	errInvalidValidatorSeals = errors.New("invalid validator seals")
	...
	errValidatorNotFound = errors.New("validator not found with index")
)
